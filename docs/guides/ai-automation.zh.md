...
如果你准备让外部本地工具直接发起写操作，建议把 [AI 防火墙](ai-firewall.md) 和本页一起看。模型窗口主要讲怎么接 AI Provider，防火墙页主要讲模型开始发请求之后，TradeArk 怎么限制每个 AI 客户端能做什么。
...
如果你想完整了解“怎么创建命名客户端、怎么绑定账户范围、怎么设置预下单限制、watchdog 会在什么情况下介入”，下一步直接看 [AI 防火墙](ai-firewall.md)。
